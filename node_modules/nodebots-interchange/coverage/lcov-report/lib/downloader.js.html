...
<head>
    <title>Code coverage report for lib/downloader.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">lib</a> downloader.js</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">96.4% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>107/111</span>
            </div>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">4x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">// This module executes the downloading of the files properly.
...
&nbsp;
    if (typeof(opts) === 'undefined') {
      ...
      this.fw = opts.fw || <span class="branch-1 cbranch-no" title="branch not covered" >undefined;</span>
    }
  }
&nbsp;
&nbsp;
...
<span class="cstat-no" title="statement not covered" >              fsextra.removeSync(tmpdir.name);</span>
<span class="cstat-no" title="statement not covered" >              tmpdir.removeCallback();</span>
...
<span class="cstat-no" title="statement not covered" >        reject(new Error('Cannot get path to hex file', e));</span>
      }
&nbsp;
      resolve({hexpath});
    });
...
&nbsp;
  download(firmware, options) {
    ...
    return new Promise((resolve, reject) =&gt; {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof(firmware) === 'undefined') {
