...
<head>
    <title>Code coverage report for lib/interchange_client.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">lib</a> interchange_client.js</h1>
        <div class='clearfix'>
...
<a name='L153'></a><a href='#L153'>153</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">4x</span>
...
<span class="cline-any cline-yes">4x</span>
<span class="cline-any cline-yes">4x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const events = require('events');
...
&nbsp;
  const state_dump = (data) =&gt; {
    ...
    try {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (current_callback != null) {
...
&nbsp;
    await new Promise((resolve, reject) =&gt; {
      ...
      await setTimeout(<span class="fstat-no" title="function not covered" >()</span> =&gt; {}, 20);
      cb();
...
&nbsp;
  Object.defineProperties(this, {
    ...
    'port': {
      set(p) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (p != undefined) {
