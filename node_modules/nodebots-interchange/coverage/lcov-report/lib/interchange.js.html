...
<head>
    <title>Code coverage report for lib/interchange.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">lib</a> interchange.js</h1>
        <div class='clearfix'>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>66/79</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>132/135</span>
            </div>
...
<a name='L457'></a><a href='#L457'>457</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">3x</span>
...
Interchange.prototype.clean_temp_dir = function(tmpdir) {
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (tmpdir != undefined &amp;&amp; tmpdir !== null &amp;&amp; tmpdir !== '') {
...
&nbsp;
  ...
  firmwares.forEach((firmware) =&gt; {
    fws.push({
      name: firmware.name,
      firmata: (firmware.firmata ? true : <span class="branch-1 cbranch-no" title="branch not covered" >false)</span>,
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (firmataName === true) {
    // set it to empty string
<span class="cstat-no" title="statement not covered" >    firmataName = '';</span>
  }
&nbsp;
...
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (fw == undefined) {
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (useFirmata) {
<span class="cstat-no" title="statement not covered" >    if (! fw.firmata) {</span>
<span class="cstat-no" title="statement not covered" >      throw new Error(`Firmware ${fw.name} does not support custom firmata`);</span>
    }
  }
&nbsp;
  const opts = options || <span class="branch-1 cbranch-no" title="branch not covered" >{};</span>
&nbsp;
...
&nbsp;
  const board = opts.board || <span class="branch-1 cbranch-no" title="branch not covered" >'nano';</span> // assumes nano if none provided
...
&nbsp;
  const settings = {
    board: options.board || <span class="branch-1 cbranch-no" title="branch not covered" >process.env.INTERCHANGE_BOARD </span>|| <span class="branch-2 cbranch-no" title="branch not covered" >'nano',</span>
    port: options.port || <span class="branch-1 cbranch-no" title="branch not covered" >process.env.INTERCHANGE_PORT,</span>
...
&nbsp;
          if (typeof(fw_details) === 'undefined') {
            ...
            <span class="missing-if-branch" title="else path not taken" >E</span>if (data.creatorID == undefined || data.creatorID == 'undefined') data.creatorID = '0x00';
            fw_details = {
              name: 'Unknown',
...
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Tue Jan 26 2021 12:18:26 GMT+1100 (Australian Eastern Daylight Time)
            </div>
        </div>
